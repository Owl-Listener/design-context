...
## 2026-08-09 — mood.md predates the July research and is read as historical intent
...
**Because:** Usability round two, nine children aged five to eight, three with an ADHD diagnosis. The completion animation became the goal rather than the marker. Two children reopened books they had already finished in order to trigger it again, and three parents reported that it made stopping at bedtime harder. The reward was competing with the reading instead of supporting it.
**Supersedes:** none
**Status:** settled

## 2026-06-20 — The child never sees a score
**Decision:** No points, levels, percentages, or progress bars appear in the child's view. Progress information lives in the parent view only.
**Because:** A visible number turns reading into something you can be behind on. The child's screen should carry no measurement they could fail at.
**Supersedes:** none
**Status:** settled
